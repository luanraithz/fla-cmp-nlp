...
public class MessageTranslator {
    ...
    static {
        ...
        messages.put("Era esperado idComposto", withDefaultPrefix("Era esperado idComposto"));
        messages.put("Era esperado int", withDefaultPrefix("Era esperado int"));
        messages.put("Era esperado float", withDefaultPrefix("Era esperado float"));
        messages.put("Era esperado string", withDefaultPrefix("Era esperado string"));
        messages.put("Era esperado \"[\"", withDefaultPrefix("Era esperado \"[\""));
        messages.put("Era esperado \"]\"", withDefaultPrefix("Era esperado \"]\""));
        messages.put("Era esperado \"(\"", withDefaultPrefix("Era esperado \"(\""));
        messages.put("Era esperado \")\"", withDefaultPrefix("Era esperado \")\""));
        messages.put("Era esperado \";\"", withDefaultPrefix("Era esperado \";\""));
